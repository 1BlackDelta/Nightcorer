...
**34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${Radiostations[34 - 1].split(" ")[1]})`, inline: true
    ...
    if (Number(i) === 35) {
      ...
      return message.reply(new MessageEmbed()
        .setColor("#F0EAD6")
        .setAuthor(`That's not a valid radio station, please use a number between \`1\` and \`${Radiostations.length}\``));
    }
    ...
    message.channel.send(new MessageEmbed().setColor("#F0EAD6")
      .setAuthor(`Searching 🔍 ${Radiostations[i - 1].split(" ")[0]}`, 'https://cdn.discordapp.com/attachments/993820371264475218/993820631189688401/NC-loadingnew.gif'));
    //mute the bot
